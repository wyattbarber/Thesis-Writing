...
distance averaging 10mm. The standard deviation $\sigma_{\Delta d}$ also decreases between 1000mm and 500mm distance. Both trends
...
Interestingly, $\sigma_{\Delta d}$ is zero at 2000mm distance; all measured distances are identical. 
...
The azimuth angle errors in table \ref{tab:azim-error} and Fig. \ref{fig:azim-error} show a trend of increasing $\mu_{\Delta \alpha}$ 
and  $\sigma_{\Delta \alpha}$  as the distance to the object decreases.
