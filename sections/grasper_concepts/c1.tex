...
This concept consists of an actuator with 3 SMA wires and a granular core (see figure \ref{fig:poses}) cabable 
...
The actuator will use SMA wires to actively transition between 3 positions shown in figure \ref{fig:poses}:
\begin{itemize}
...
A core designed to transition between flexible and solid via the jamming transition (figure \ref{fig:crosssec}) will allow the tendril to remain
...
Figure \ref{fig:schematic} shows a simple diagram of the electrical and mechanical components involved in the proposed device.  
...
activating the jamming behavior of the coffee grounds within. Two concepts for this mechanism are shown in figure \ref{fig:pump}.
...
used a balloon, which is thinner and more flexible allowing the coffee grounds inside to bear the load of the . 
...
Trying again with a thinner tube (a balloon, the long type used to make balloon animals) showed little improvement. 
