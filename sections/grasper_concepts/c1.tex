...
This concept consists of an actuator with 3 SMA wires and a granular core (see Fig. \ref{fig:poses}) cabable 
...
The actuator will use SMA wires to actively transition between 3 positions shown in Fig. \ref{fig:poses}:
\begin{itemize}
...
A core designed to transition between flexible and solid via the jamming transition (Fig. \ref{fig:crosssec}) will allow the tendril to remain
...
Fig. \ref{fig:schematic} shows a simple diagram of the electrical and mechanical components involved in the proposed device.  
...
activating the jamming behavior of the coffee grounds within. Two concepts for this mechanism are shown in Fig. \ref{fig:pump}.
