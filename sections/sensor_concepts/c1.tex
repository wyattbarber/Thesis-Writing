...
Fig. \ref{fig:c1:depth_profiles} shows images from the proof of concept pipeline, obtained from 
processing Fig. \ref{fig:c1:testimg}. All image processing functions used are implemented by OpenCV.
...
\begin{figure}[H]
    ...
    parallel lines identified in Fig. \ref{fig:c1:testimg} (the parallel lines are drawn in green),
