...
Figure \ref{fig:c2:depth} shows a sample frame from the ground truth data, 
and figure \ref{fig:c2:depth_est} shows an example depth estimate from this process.
