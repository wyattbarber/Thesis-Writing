...
There are 3 position measurements relevant for the perch detection in this thesis:

\begin{itemize}
    \item $d$: Distance, measured along the z-axis between the camera and test object. Illustrated in Fig. \ref{fig:distance}
    \item $\alpha$: Azimuth, angle between the y-axis and the test object. Illustrated in Fig. \ref{fig:angles}
    \item $\theta$: Elevation, angle between the x-y plane and the test object. Illustrated in Fig. \ref{fig:angles}
\end{itemize}
