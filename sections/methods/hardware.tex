...
Table \ref{tab:weights} shows the assessed models and their weights.
...
The weight of the prototype device was measured with a kitchen scale. The overall weight and weight of individual 
components of the device were recorded in table \ref{tab:weights}.
