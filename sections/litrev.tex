...
One such device is that proposed by Hoang et al., shown in Fig. \ref{fig:clasp}, which is intended for use in power line inspection. It uses ribbons to passively close an electromagnetic clasp once the drone has approached 
