...
The possible uses for drone perching in ecological data collection may be overstated. Michigan state affiliated researchers 
...
to be comfortable leaving it unattended in a tree \cite{dohm_notitle_2024, ostaszewski_notitle_2024}. Though it is worth considering that the 
...
\subsubsection{Grasping} \label{sec:litrev:modes-grasping}
